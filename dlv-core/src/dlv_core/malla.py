"""Malla RPM×MAP para análisis tabular y tablas de corrección (F4, epica de
`docs/02-alcance-y-plan.md`).

Construye una tabla 2D (bins de RPM × bins de MAP/carga) con una estadística
...
def construir_malla(
    ...
    *,
    ...
    """Agrega `valor` en la malla RPM×MAP con la estadística indicada."""
