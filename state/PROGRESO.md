...
Actualizado: 2026-08-26 23:25:34Z

**427 / 775 pts cerrados (55.1 %)** · 193 pts esperando revisión humana → 80.0 % entregado
...
| `F2-05` Alineación por reloj absoluto y por relativo | en_curso | Sonnet 5 | G3 | — |
| `F2-06` Desfase manual arrastrando el segmento | en_curso | Sonnet 5 | G3 | — |
| `F2-07` Anclaje por evento (primer WOT, primer corte | en_curso | Opus 5 | G2 | — |
...
| `F4-03` Filtros de exclusión: transitorio, corte, pr | revision_humana | Opus 5 | G1 | Modulo dlv_core/exclusion.py + 450 lineas de pruebas. Cuatro motivos ( |
...
| ⏳ | `F3-14` | Decodificación de máscaras de bits en carriles apilados | Opus 5 | 5 | F3-13 | G1 | `903b3ac` |
...
| ✔  | `F5-04` | Firma y notarización | Sonnet 5 | 4 | F5-01 | G3 | `f689ebc` |
...
| ✔  | `F5-17` | Asociación de extensiones opcional y reversible | Sonnet 5 | 3 | F5-01 | G3 | `3a8f2a3` |
