...
| F1-47 | **La identidad del inyector fija tres factores**: el caudal configurado y el tiempo muerto del log, contra la especificación del inyector del propietario, corrigen `Flow` e `InjFuelVolume` (×10 los dos) y confirman `MassPerCyl` | datos + pruebas | **Opus 5** | 3 | F0-09, FG-10 | **G1** |

**Subtotal F1: 234 pts** · Hito **M1**
