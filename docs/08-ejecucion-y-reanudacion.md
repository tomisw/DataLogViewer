...
Cinco reglas. Si se cumplen, el trabajo es siempre reanudable.
...
| **G3** | comprueba que las pruebas están verdes | `hecho` |
...
El backlog es un documento de planificación y tenía dos dependencias mal puestas.
